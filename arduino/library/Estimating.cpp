...
void Estimating::begin_(float (*_input)(), void (*_output)(float))
{
...
unsigned long long int Estimating::search_delay(float _perc)
{
  float initial_input;
...
unsigned long long int Estimating::search_settling(float _perc, unsigned long long int _delay, float* _std, float* _max_input)
{
  Queue inputs(SIZE_I);
...
bool Estimating::areas_mtd(float _perc, unsigned long long int _sampling_time, float _max_input, float* _l, float* _t)
{
  Queue inputs(SIZE_I);
...
float Estimating::noise(float _perc)
{
...
bool Estimating::relay_mtd(float _perc, float _max_deriv, float* _k, float* _t, float* _l, float* _std)
{
